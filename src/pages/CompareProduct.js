            ...
            <div className="row">
                ...
                <div className="col-3">
                    <div className="compare-product-card position-relative">
                        ...
                        <div className="product-card-image">
                            <img src="/images/bluetoothSpeaker-2.jpg" alt="compare"/>
                        </div>
                        <div className="compare-product-details">
                            <h5 className="title">Sony A1 Portable Bluetooth Speaker With Microphone</h5>
                            <h6 className="price mt-3">$200.00</h6>
                            <div>
                                <div className="product-detail">
                                    <h5>Brand:</h5>
                                    <p>Sony</p>
                ...
                <div className="col-3">
                    <div className="compare-product-card position-relative">
                        ...
                        <div className="compare-product-details">
                            ...
                            <h6 className="price mt-3">$300.00</h6>
                            <div>
                                <div className="product-detail">
                                    <h5>Brand:</h5>
                                    <p>Apple</p>
                ...
                <div className="col-3">
                    <div className="compare-product-card position-relative">
                        ...
                        <div className="product-card-image">
                            <img src="/images/bluetoothSpeaker-1.jpg" alt="compare"/>
                        </div>
                        <div className="compare-product-details">
                            <h5 className="title">Sony A1 Portable Bluetooth Speaker With Microphone</h5>
                            <h6 className="price mt-3">$198.00</h6>
                            <div>
                                <div className="product-detail">
                                    <h5>Brand:</h5>
                                    <p>Sony</p>
