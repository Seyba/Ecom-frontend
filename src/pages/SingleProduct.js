                    ...
                    <div className="row">
                        ...
                        <div className="col-6 px-4">
                            ...
                            <div className="prod_detail_info">
                                ...
                                <div className="d-flex gap-10 flex-column my-2">
                                    <h3 className="prod_detail__heading">Color: </h3> <div className="prod_detail__data"><Color/></div>
                                </div>
                                ...
                                <div className="prod-footer-payment">
                                    ...
                                    <div className="d-flex justify-content-center gap-10">
                                        <div className="">
                                            <svg enableBackground="new 0 0 780 500" height="40" viewBox="0 0 780 500" width="40" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div>
                                            <svg height="40" viewBox="0 0 780 500" width="40" xmlns="http://www.w3.org/2000/svg"><g fillRule="evenodd">
